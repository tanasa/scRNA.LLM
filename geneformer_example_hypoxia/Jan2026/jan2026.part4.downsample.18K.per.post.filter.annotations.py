...
# reuse the old script : geneformer_hypoxia_downsample_sep10_down_subsampling.oct20.18k.18k.18k.py
...
3. Balanced Stratification:
   EQUAL18k representation across groups
...
# ========= CONFIG =========
CELLS_PER_CONDITION = 18000     # 18000 cells per condition
TOTAL_TARGET = 36000            # 18000 * 2 conditions
SEED = 42
SAVE_PATH = "./hypoxia_18K_per_condition.dataset"
NUM_PROC = 8
# ==========================

print("="*80)
print("STRATIFIED EQUAL SUBSAMPLING: 18000 CELLS PER CONDITION")
print("="*80)
...
comparison_df.to_csv("EQUAL_18K_subsampling_comparison.csv", index=False)
...
# =============================================================================
# BARPLOTS: BEFORE vs AFTER EQUAL_18K SUBSAMPLING
# =============================================================================
...
fig.suptitle('Cell Type Percentages: Before vs After EQUAL_18K Downsampling', fontsize=16, fontweight='bold')
...
plt.tight_layout()
plt.savefig('EQUAL_18K_subsampling_barplots.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig('EQUAL_18K_subsampling_side_by_side.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig('EQUAL_18K_subsampling_differences.png', dpi=300, bbox_inches='tight')
plt.show()

print("✅ Barplots saved:")
print("  - EQUAL_18K_subsampling_barplots.png")
print("  - EQUAL_18K_subsampling_side_by_side.png") 
print("  - EQUAL_18K_subsampling_differences.png")
