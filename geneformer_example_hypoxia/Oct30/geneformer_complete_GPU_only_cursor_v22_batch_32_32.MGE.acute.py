...
# Input paths
model_directory = "/mnt/nfs/CX000008_DS1/projects/btanasa/hypoxia/test_geneformer_3_full_h5ad.reprocess.sep10.oct20.balanced.09000.09000.0900.model/251024213134.bak.0.8.epochs/251024_geneformer_cellClassifier_hypoxia_condition_classifier_optimized/ksplit1/checkpoint-316"
input_data_file = "/mnt/nfs/CX000008_DS1/projects/btanasa/hypoxia/test_geneformer_3_full_h5ad.reprocess.sep10.oct20.balanced.09000.09000.0900.dataset/hypoxia_EQUAL09k_9000_per_condition.dataset"
...
cell_type = "Imm-MGE"  # Change this to analyze different cell types
...
CONFIG = {
    ...
    "emb_nproc": 20,            # Processes for embedding extraction
    ...
    "output_prefix": f"cell_type_ISP_{cell_type}_GPU_ONLY"
}
...
PERTURBATION_STRATEGY = "acute"  # Change this to "chronic" for chronic analysis
...
CONFIG["output_prefix"] = f"cell_type_ISP_{cell_type}_{PERTURBATION_STRATEGY}_GPU_ONLY"
...
output_dir = f"/mnt/nfs/CX000008_DS1/projects/btanasa/hypoxia/test_geneformer_3_full_h5ad.reprocess.sep10.oct20.balanced.09000.09000.0900.model.isp/{cell_type}_{PERTURBATION_STRATEGY}_{datestamp}_GPU_ONLY"
...
log_file = os.path.join(log_dir, f"isp_analysis_{PERTURBATION_STRATEGY}_GPU_ONLY_{timestamp}.log")
