...
TOTAL_TARGET = 54000           # 18000 * 3 conditions
SEED = 42
SAVE_PATH = "./hypoxia_EQUAL18k_18000_per_condition.dataset"
NUM_PROC = 8
# ==========================
...
comparison_df.to_csv("EQUAL18k_subsampling_comparison.csv", index=False)
...
# =============================================================================
# BARPLOTS: BEFORE vs AFTER EQUAL18k SUBSAMPLING
# =============================================================================
...
fig.suptitle('Cell Type Percentages: Before vs After EQUAL18k Downsampling', fontsize=16, fontweight='bold')
...
plt.tight_layout()
plt.savefig('EQUAL18k_subsampling_barplots.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig('EQUAL18k_subsampling_side_by_side.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig('EQUAL18k_subsampling_differences.png', dpi=300, bbox_inches='tight')
plt.show()

print("✅ Barplots saved:")
print("  - EQUAL18k_subsampling_barplots.png")
print("  - EQUAL18k_subsampling_side_by_side.png") 
print("  - EQUAL18k_subsampling_differences.png")


# In[ ]:


# In the currant implementation, the EQUAL18k sampling does NOT filter cells based on a 1% threshold.


# In[ ]:


# The resulting folder is : hypoxia_EQUAL18k_9000_per_condition.dataset
