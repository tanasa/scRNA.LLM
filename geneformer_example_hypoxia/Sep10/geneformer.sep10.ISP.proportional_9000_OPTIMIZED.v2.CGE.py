...
logger.info("=" * 80)
logger.info(f"Script: test_ISP_hypoxia2000_v11-all_genes_Inh_CGE.sep11.proportional9000_OPTIMIZED.py")
...
cell_type = "Imm-CGE"  # Change this to analyze different cell types
