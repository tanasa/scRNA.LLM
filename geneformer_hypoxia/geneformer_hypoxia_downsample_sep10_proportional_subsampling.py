...
# =============================================================================
# PROPORTIONAL SUBSAMPLING: 3000 CELLS PER CONDITION
# =============================================================================
...
# ========= CONFIG =========
CELLS_PER_CONDITION = 3000    # 3000 cells per condition
TOTAL_TARGET = 9000           # 3000 * 3 conditions
SEED = 42
SAVE_PATH = "./hypoxia_proportional_3000_per_condition.dataset"
NUM_PROC = 8
# ==========================

print("="*80)
print("PROPORTIONAL SUBSAMPLING: 3000 CELLS PER CONDITION")
print("="*80)
...
# 3) Proportional subsampling per condition
print(f"\n" + "="*60)
print("PROPORTIONAL SUBSAMPLING PER CONDITION")
print("="*60)
...
for condition in conditions:
    ...
    # Adjust for rounding errors to get exactly 3000 cells
...
print(f"\n" + "="*60)
print("VERIFICATION OF PROPORTIONAL SUBSAMPLING")
print("="*60)
...
print(f"\n" + "="*60)
print("PROPORTIONAL SUBSAMPLING COMPLETE")
print("="*60)
...
# =============================================================================
# COMPARISON: BEFORE vs AFTER PROPORTIONAL SUBSAMPLING
# =============================================================================

print(f"\n" + "="*80)
print("COMPARISON: BEFORE vs AFTER PROPORTIONAL SUBSAMPLING")
print("="*80)
...
comparison_df.to_csv("proportional_subsampling_comparison.csv", index=False)
print(f"\n✅ Comparison data saved to: proportional_subsampling_comparison.csv")
...
# =============================================================================
# BARPLOTS: BEFORE vs AFTER PROPORTIONAL SUBSAMPLING
# =============================================================================
...
fig.suptitle('Cell Type Percentages: Before vs After Proportional Downsampling', fontsize=16, fontweight='bold')
...
plt.tight_layout()
plt.savefig('proportional_subsampling_barplots.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig('proportional_subsampling_side_by_side.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig('proportional_subsampling_differences.png', dpi=300, bbox_inches='tight')
plt.show()

print("✅ Barplots saved:")
print("  - proportional_subsampling_barplots.png")
print("  - proportional_subsampling_side_by_side.png") 
print("  - proportional_subsampling_differences.png")


# In[ ]:


# In the currant implementation, the proportional sampling does NOT filter cells based on a 1% threshold.


# In[ ]:


# The resulting folder is : hypoxia_proportional_3000_per_condition.dataset
