...
logger.info("=" * 80)
logger.info(f"Script: test_ISP_hypoxia2000_v11-all_genes_Premyelinating-Olig.sep11.proportional9000_OPTIMIZED.py")
...
cell_type = "Premyelinating-Olig"  # Change this to analyze different cell types
